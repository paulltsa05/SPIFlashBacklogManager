...
#define ALTRECORDSIZEBYTES					LDRECORDSIZEBYTES
#define NOOF_RECORDINSECTOR					45 //(FLASHSECTORSIZEBYTES/LDRECORDSIZEBYTES)
#define NOOF_LDRECORDINSECTOR				NOOF_RECORDINSECTOR
#define NOOF_EMGRECORDINSECTOR				NOOF_RECORDINSECTOR
#define NOOF_ALTRECORDINSECTOR				NOOF_RECORDINSECTOR


#define RECORDMANAGE_SECTORSTART			62 //sector
#define RECORDMANAGE_SECTORSIZE				4  //in sector count
#define EMGRECORD_SECTORSTART				RECORDMANAGE_SECTORSTART+RECORDMANAGE_SECTORSIZE //66=62+4 sector
#define EMGRECORD_SECTORSIZE				2
#define ALTRECORD_SECTORSTART				EMGRECORD_SECTORSTART+EMGRECORD_SECTORSIZE //68=66+2 sector
#define ALTRECORD_SECTORSIZE				10
#define LDRECORD_SECTORSTART				ALTRECORD_SECTORSTART+ALTRECORD_SECTORSIZE //78=68+10 sector
#define LDRECORD_SECTORSIZE					FLASHTOTALNOOFSECTOR-LDRECORD_SECTORSTART // 1024-78 = 946 sectors
